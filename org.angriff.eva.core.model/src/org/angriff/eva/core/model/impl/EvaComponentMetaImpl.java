...
public class EvaComponentMetaImpl extends EObjectImpl implements EvaComponentMeta {
	 ...
	 * @ordered
	 */
	protected EList factoryArguments;
	 ...
	 * @generated
	 */
	public EList getFactoryArguments() {
		if (factoryArguments == null) {
			factoryArguments = new EObjectResolvingEList(EvaArgument.class, this, EvaModelPackage.EVA_COMPONENT_META__FACTORY_ARGUMENTS);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case EvaModelPackage.EVA_COMPONENT_META__FACTORY_ARGUMENTS:
				...
				getFactoryArguments().addAll((Collection)newValue);
				return;
		}
