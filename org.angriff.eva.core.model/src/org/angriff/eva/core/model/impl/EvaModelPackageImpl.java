...
public class EvaModelPackageImpl extends EPackageImpl implements EvaModelPackage {
	...
	public void initializePackageContents() {
		...
		addEEnumLiteral(evaParameterTypeEEnum, EvaParameterType.STRING_LITERAL);
		addEEnumLiteral(evaParameterTypeEEnum, EvaParameterType.INTEGER_LITERAL);
		addEEnumLiteral(evaParameterTypeEEnum, EvaParameterType.DOUBLE_LITERAL);
		addEEnumLiteral(evaParameterTypeEEnum, EvaParameterType.FLAG_LITERAL);
		addEEnumLiteral(evaParameterTypeEEnum, EvaParameterType.CLASS_LITERAL);
		addEEnumLiteral(evaParameterTypeEEnum, EvaParameterType.SELECTABLE_ONE_LITERAL);
		addEEnumLiteral(evaParameterTypeEEnum, EvaParameterType.SELECTABLE_MANY_LITERAL);
